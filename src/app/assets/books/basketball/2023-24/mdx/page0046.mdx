...
Rule 4-43 SECTION 43 TIME-OUT ART.
...
A 60-second time-out charged to a team is a maximum of one minute in length.

A 30-second time-out charged to a team is a maximum 30 seconds in length.

A warning is sounded 15 seconds prior to the expiration of the 30 or 60 seconds.
...
SECTION 44 TRAVELING Traveling is moving a foot or feet in any direction in excess of prescribed limits while holding the ball.
...
SECTION 45 VERTICALITY Verticality applies to a legal position.

Following are the basic components of the principle of verticality:
...
2023-24 NFHS Basketball Rules Page 44
