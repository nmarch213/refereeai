...
2023-2 4 NFHS Basketball Rules BASKETBALL RULES FUNDAMENTALS Page 81 1.
...
Neither a team nor any player is ever in control during a dead ball, jump ball, or when the ball is in flight during a try or tap for a goal.
...
Personal fouls always involve illegal contact and occur during a live ball, except for fouls committed by an airborne shooter or on an airborne shooter.
...
A live-ball foul by the offense (team in control or last in control if the ball is loose), or the expiration of time for a quarter or extra period, causes the ball to become dead immediately, unless the ball is in flight during a try or tap for field goal.

The ball also becomes dead when a player-control foul occurs.
...
A double personal foul involves only personal fouls and only two opponents; no free throws are awarded and the ball is put in play at the point of interruption.

A double technical foul involves only technical fouls and only two opponents; no free throws are awarded, and the ball is put in play at the point of interruption.
...
Whether the clock is running or is stopped has no influence on the counting of a field goal.

19.

A ball which touches the front face or edges of the backboard is treated the same as touching the floor inbounds, except that when the ball touches the thrower's back- board, it does not constitute a part of a dribble.
