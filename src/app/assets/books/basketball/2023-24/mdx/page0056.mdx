...
Rule 7-3 2023-24 NFHS Basketball Rules Page 54 ART.
...
SECTION 3 CAUSING THE BALL TO GO OUT OF BOUNDS – SIMULTANEOUSLY ART.
...
A held ball, as in Rule 4-25, after the alternating-possession proce- dure has been established.

SECTION 5 RESUMPTION-OF-PLAY PROCEDURE, THROW-INS ART.
...
When a team does not make a thrower available, after a time-out (as in Rule 7-4-4) or the intermission between any quarter (as in Rule 6-2-3), the resumption-of-play procedure is used to prevent delay.
...
After an out-of-bounds violation in either the frontcourt or the back- court by either team as in 9-3, the throw-in shall be at the designated spot nearest to where the ball went out of bounds.
