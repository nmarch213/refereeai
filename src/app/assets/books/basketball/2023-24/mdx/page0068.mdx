...
Rule 10-2 2023-24 NFHS Basketball Rules Page 66 ART.
...
(Section 1) Two free throws plus the ball for a division-line throw-in.

(Arts.

3 & 4) Penalized when they occur.

SECTION 2 TEAM TECHNICAL ART.
...
See Rules 7-5-1 and 8-1-2 for the resumption-of-play pro- cedure to use after a time-out or the intermission between quarters.

The pro- cedure is used prior to charging a technical foul in these specific situations.
...
(Section 2) Two free throws plus the ball for a division-line throw-in.

(Arts.

1, 4, 5, 6) Penalized when they occur.

(Art.

2) Penalized if discovered while being violated.

(Art.

3) Penalized when discovered.
...
(Section 3) Two free throws plus the ball for a division-line throw- in.
