...
Page 43 2023-2 4 NFHS Basketball Rules Rule 4-41 SECTION 41 SHOOTING, TRY, TAP ART.
...
A player is trying for goal when the player has the ball and in the official's judgment is throwing or attempt- ing to throw for goal.
...
SECTION 42 THROW-IN, THROWER, DESIGNATED SPOT ART.
...
The passed ball touches or is touched by another player out-of-bounds, except as in Rule 7-5-7.
...
The designated throw-in spot is 3 feet wide with no depth limita- tion and is established and signaled by the official prior to putting the ball at the thrower's disposal.

NOTE:

The thrower shall keep one foot on or over the designated spot until the ball is released.

The traveling and dribbling rules are not in effect for a throw-in.
