...
Page 37 2023-2 4 NFHS Basketball Rules Rule 4-21 ART.
...
A player touches the ball during a try or tap for field goal while the ball is in its downward flight entirely above the basket ring level, has the possibili- ty of entering the basket in flight and is not touching the basket cylinder; ART.
...
Guarding is the act of legally placing the body in the path of an offen- sive opponent.

There is no minimum distance required between the guard and op- ponent, but the maximum is 6 feet when closely guarded.
